    ...
    <>
      ...
      <button
        ...
        className={classNames(
          'absolute left-2 bottom-2 z-10 px-2 py-2 rounded-md text-lg text-accent',
          {
      ...
      >
        <svg
          ...
          className={classNames('w-8 h-8', {
            ' fill-secondary/80': !showAnnotations,
            'fill-black hover:fill-secondary': showAnnotations,
          })}
